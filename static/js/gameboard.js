...
/*
This whole file is essentially just a port of the hexgrid and gameboard python modules.
 */
...
var test = new HexGrid();
test.set("0,0", "A tile!");
test.set("0,0,CORNER_NE", "A ne corner!");
test.set("0,0,CORNER_N", "A northerly corner!");
test.set("0,0,CORNER_NW", "nw corner");
test.set("0,0,CORNER_SW", "sw corner");
test.set("0,0,CORNER_S", "s corner");
test.set("0,0,CORNER_SE", "SE corner");

console.log(test.getTileNeighbors("-1,1,CORNER_S"));